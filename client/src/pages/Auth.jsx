...
import { Auth as FirebaseAuth, Provider } from "../utils/firebase";
import { useUser } from "../hooks/useUser";

/**
 * Authentication Page Component
 * Consistent with Dashboard design - teal accent, stone neutrals
 */
const Auth = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Register user in backend with their Google profile
          ...
          <div className="bg-surface rounded-lg border border-border shadow-sm p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2.5 text-text-secondary">
                ...
                <span className="text-sm">Generate notes in seconds</span>
              </div>
            </div>
          </div>
